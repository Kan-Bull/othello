...
async function collectElements(page, url) {
    ...
    const raw = await page.evaluate(() => {
        ...
        // Inputs & textareas
        const inputEls = Array.from(document.querySelectorAll("input:not([type='hidden']):not([type='submit']):not([type='button']):not([type='reset']), textarea"));
        ...
        // Buttons
        const buttonEls = Array.from(document.querySelectorAll("button, input[type='submit'], input[type='button'], input[type='reset']"));
        ...
        const alertEls = Array.from(document.querySelectorAll('[role="alert"], [aria-live], .error, .danger, .invalid, .alert-danger, .alert-error'));
